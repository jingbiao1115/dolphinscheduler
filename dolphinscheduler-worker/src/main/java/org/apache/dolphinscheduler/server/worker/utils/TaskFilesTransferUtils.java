...
public class TaskFilesTransferUtils {
	 ...
	 *            is the context of task
	 * @param storageOperate
	 *            is the storage operate
	 * @throws TaskException
	 *             TaskException
	 */
	public static void uploadOutputFiles(TaskExecutionContext taskExecutionContext, StorageOperate storageOperate)
			throws TaskException {
	...
	/**
	 * download upstream files from storage only download files which are defined in
	 * the task parameters
	 *
	 * @param taskExecutionContext
	 *            is the context of task
	 ...
	 *            is the context of task
	 * @param direct
	 *            may be Direct.IN or Direct.OUT.
	 ...
	 *
	 * @param path
	 *            is the input path, may be a file or a directory
	 * @return new path
	 */
