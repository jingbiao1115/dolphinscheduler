...
public class WorkerRegistryClient implements AutoCloseable {
	...
	public void initWorkRegistry() {
		this.workerHeartBeatTask = new WorkerHeartBeatTask(workerConfig, metricsProvider, registryClient,
	...
	public void start() {
		try {
			registry();
			registryClient
					.addConnectionStateListener(new WorkerConnectionStateListener(workerConfig, workerConnectStrategy));
		} catch (Exception ex) {
