...
public class WorkerWaitingStrategy implements WorkerConnectStrategy {
	...
	public WorkerWaitingStrategy(@NonNull WorkerConfig workerConfig, @NonNull RegistryClient registryClient,
			@NonNull MessageRetryRunner messageRetryRunner, @NonNull WorkerTaskExecutorThreadPool workerManagerThread) {
	...
	public void disconnect() {
		try {
			...
			try {
				log.info("Worker disconnect from registry will try to reconnect in {} s", maxWaitingTime.getSeconds());
