...
public class WorkerServer implements IStoppable {
	...
	public void close(String cause) {
		...
		try (WorkerRpcServer closedWorkerRpcServer = workerRpcServer;
			...
			// since for some task, we need to take-over the remote task after the worker
			// restart
			// and if the worker crash, the `killAllRunningTasks` will not be execute, this
			// will cause there exist two
			// kind of situation:
