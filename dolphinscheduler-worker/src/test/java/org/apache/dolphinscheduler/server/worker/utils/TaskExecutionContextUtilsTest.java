...
class TaskExecutionContextUtilsTest {
	...
	void createTaskInstanceWorkingDirectory() throws IOException {
		...
		String taskWorkingDirectory = FileUtils.getTaskInstanceWorkingDirectory(taskExecutionContext.getTenantCode(),
				taskExecutionContext.getProjectCode(), taskExecutionContext.getProcessDefineCode(),
