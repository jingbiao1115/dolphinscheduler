...
public final class VoiceAlertChannelFactory implements AlertChannelFactory {
	...
	public List<PluginParams> params() {
		...
		InputParam calledNumber = InputParam
				.newBuilder(VoiceAlertConstants.NAME_CALLED_NUMBER, VoiceAlertConstants.CALLED_NUMBER)
		...
		InputParam accessKeyId = InputParam
				.newBuilder(VoiceAlertConstants.NAME_ACCESS_KEY_ID, VoiceAlertConstants.ACCESS_KEY_ID)
				.setPlaceholder(AlertInputTips.ALIYUN_VIICE_ACCESSKEYID.getMsg())
				.addValidate(Validate.newBuilder().setRequired(false).build()).build();
		InputParam accessKeySecret = InputParam
				.newBuilder(VoiceAlertConstants.NAME_ACCESS_KEY_SECRET, VoiceAlertConstants.ACCESS_KEY_SECRET)
