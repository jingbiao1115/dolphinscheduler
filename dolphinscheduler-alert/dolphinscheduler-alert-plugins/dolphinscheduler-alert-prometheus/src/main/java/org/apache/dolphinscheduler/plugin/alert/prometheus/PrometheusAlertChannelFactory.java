...
public final class PrometheusAlertChannelFactory implements AlertChannelFactory {
	...
	public List<PluginParams> params() {
		InputParam urlParam = InputParam
				.newBuilder(PrometheusAlertConstants.NAME_ALERT_MANAGER_URL, PrometheusAlertConstants.ALERT_MANAGER_URL)
				.setPlaceholder(AlertInputTips.URL.getMsg())
				.addValidate(Validate.newBuilder().setRequired(true).build()).build();
		InputParam annotationParam = InputParam
		...
		InputParam generatorUrlParam = InputParam
