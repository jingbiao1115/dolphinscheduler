...
public enum WebexTeamsDestination {
	...
	/**
	 * 0 ROOM_ID; 1 PERSON_EMAIL; 2 PERSON_ID;
	 */
	ROOM_ID(0, "roomId"), PERSON_EMAIL(1, "personEmail"), PERSON_ID(2, "personId");
	...
	private static final Map<String, WebexTeamsDestination> WEBEX_TEAMS_DESTINATION_MAP = Arrays
			.stream(WebexTeamsDestination.values())
