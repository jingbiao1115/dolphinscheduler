...
public class TelegramSenderTest {
	...
	public void initConfig() {
		...
		telegramConfig.put(TelegramParamsConstants.NAME_TELEGRAM_BOT_TOKEN, "BOT_TOKEN");
		telegramConfig.put(TelegramParamsConstants.NAME_TELEGRAM_CHAT_ID, "CHAT_ID");
		telegramConfig.put(TelegramParamsConstants.NAME_TELEGRAM_PARSE_MODE, TelegramAlertConstants.PARSE_MODE_TXT);
	}
	...
	public void testSendMessageFailByParamToken() {
		...
		telegramConfig.put(TelegramParamsConstants.NAME_TELEGRAM_BOT_TOKEN, "XXXXXXX");
	...
	public void testSendMessageFailByChatId() {
		...
		alertData.setTitle("[telegram alert] test title");
		alertData.setContent("telegram test content");
		telegramConfig.put(TelegramParamsConstants.NAME_TELEGRAM_CHAT_ID, "-XXXXXXX");
		TelegramSender telegramSender = new TelegramSender(telegramConfig);
		AlertResult result = telegramSender.sendMessage(alertData);
		Assertions.assertEquals("false", result.getStatus());
	}
	...
	public void testSendMessageByMarkdown() {
		...
		telegramConfig.put(TelegramParamsConstants.NAME_TELEGRAM_PARSE_MODE,
				TelegramAlertConstants.PARSE_MODE_MARKDOWN);
		TelegramSender telegramSender = new TelegramSender(telegramConfig);
		AlertResult result = telegramSender.sendMessage(alertData);
		Assertions.assertEquals("false", result.getStatus());
	...
	public void testSendMessageByHtml() {
		...
		telegramConfig.put(TelegramParamsConstants.NAME_TELEGRAM_PARSE_MODE, TelegramAlertConstants.PARSE_MODE_HTML);
		TelegramSender telegramSender = new TelegramSender(telegramConfig);
		AlertResult result = telegramSender.sendMessage(alertData);
		Assertions.assertEquals("false", result.getStatus());
