...
public class AlertOperatorImpl implements IAlertOperator {
	...
	public AlertSendResponse sendAlert(AlertSendRequest alertSendRequest) {
		...
		AlertSendResponse alertSendResponse = alertBootstrapService.syncHandler(alertSendRequest.getGroupId(),
				alertSendRequest.getTitle(), alertSendRequest.getContent(), alertSendRequest.getWarnType());
	...
	public AlertSendResponse sendTestAlert(AlertTestSendRequest alertSendRequest) {
		...
		AlertSendResponse alertSendResponse = alertBootstrapService.syncTestSend(alertSendRequest.getPluginDefineId(),
