...
public interface Registry extends Closeable {
	 ...
	 *
	 * @param timeout
	 *            max timeout, if timeout <= 0 will wait indefinitely.
	 * @throws RegistryException
	 *             cannot connect in the given timeout
	 */
	 ...
	 *            if true, when the connection state is disconnected, the key will
	 *            be deleted
	 */
	 ...
	 * 
	 * @param key
	 *            the prefix of deleted key
	 * @throws if
	 *             the key not exists, there is a registryException
	 */
	void delete(String key);

	/**
	 * @return {@code true} if key exists. E.g: registry contains the following
	 *         keys:[/test/test1/test2,] if the key: /test Return: test1
	 */
