 ...
 *
 * <code>ShellExecutor</code> should be used in cases where the output of the
 * command needs no explicit parsing and where the command, working directory
 * and the environment remains unchanged. The output of the command is stored
 * as-is and is expected to be small.
 */
public class ShellExecutor extends AbstractShell {
	 ...
	 * @param dir
	 *            If not-null, specifies the directory which should be set as the
	 *            current working directory for the command. If null, the current
	 *            working directory is not modified.
	 * @param env
	 *            If not-null, environment of the command will include the key-value
	 *            pairs specified in the map. If null, the current environment is
	 *            not modified.
	 * @param timeout
	 *            Specifies the time in milliseconds, after which the command will
	 ...
	 * without requiring the user to implement the <code>AbstractShell</code>
	 * interface.
	 * 
	 * @param cmd
	...
	/**
	 * Returns the commands of this instance. Arguments with spaces in are presented
	 * with quotes round; other arguments are presented raw
	 *
