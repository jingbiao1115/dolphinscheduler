...
public class StorageConfiguration {
	...
	public StorageOperate storageOperate() {
		Optional<StorageType> storageTypeOptional = StorageType
		...
		Optional<StorageOperate> storageOperate = storageTypeOptional.map(storageType -> {
			ServiceLoader<StorageOperateFactory> storageOperateFactories = ServiceLoader
					.load(StorageOperateFactory.class);
