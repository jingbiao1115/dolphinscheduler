...
public interface StorageOperate {
	...
	/**
	 * delete the resource of filePath todo if the filePath is the type of directory
	 * ,the files in the filePath need to be deleted at all
	 * 
	 * @param filePath
	 * @param recursive
	 * @return
	 ...
	 * @param dstPath
	 * @param deleteSource
	 *            if need to delete the file of srcPath
	 * @param overwrite
	 * @return
	 * @throws IOException
	 */
	 ...
	 * @throws IOException
	 */
	boolean upload(String tenantCode, String srcFile, String dstPath, boolean deleteSource, boolean overwrite)
			throws IOException;
	 ...
	 */
	List<StorageEntity> listFilesStatus(String path, String defaultPath, String tenantCode, ResourceType type)
			throws Exception;

	/**
	 * return a file status
	 */
	StorageEntity getFileStatus(String path, String defaultPath, String tenantCode, ResourceType type) throws Exception;
}
