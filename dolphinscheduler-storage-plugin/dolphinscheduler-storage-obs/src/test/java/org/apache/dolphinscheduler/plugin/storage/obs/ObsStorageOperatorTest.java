...
public class ObsStorageOperatorTest {
	...
	public void setUp() throws Exception {
		...
		doReturn(ACCESS_KEY_ID_MOCK).when(obsOperator).readObsAccessKeyID();
		doReturn(ACCESS_KEY_SECRET_MOCK).when(obsOperator).readObsAccessKeySecret();
	...
	public void testListFilesStatus() throws Exception {
		List<StorageEntity> result = obsOperator.listFilesStatus("dolphinscheduler/default/resources/",
				"dolphinscheduler/default/resources/", "default", ResourceType.FILE);
	...
	public void testListFilesStatusRecursively() throws Exception {
		...
		List<StorageEntity> result = obsOperator.listFilesStatusRecursively(FULL_NAME, DEFAULT_PATH, TENANT_CODE_MOCK,
				ResourceType.FILE);
		Assertions.assertEquals(0, result.size());
	}
}
