...
public class GcsStorageOperatorTest {
	...
	public void testGetFileStatus() throws Exception {
		StorageEntity entity = gcsStorageOperator.getFileStatus(FULL_NAME, DEFAULT_PATH, TENANT_CODE_MOCK,
				ResourceType.FILE);
	...
	public void testListFilesStatus() throws Exception {
		...
		List<StorageEntity> result = gcsStorageOperator.listFilesStatus(FULL_NAME, DEFAULT_PATH, TENANT_CODE_MOCK,
				ResourceType.FILE);
	...
	public void testListFilesStatusRecursively() throws Exception {
		...
		List<StorageEntity> result = gcsStorageOperator.listFilesStatusRecursively(FULL_NAME, DEFAULT_PATH,
