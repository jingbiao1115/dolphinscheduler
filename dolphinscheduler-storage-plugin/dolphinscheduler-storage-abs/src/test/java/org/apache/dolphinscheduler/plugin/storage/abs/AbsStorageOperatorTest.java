...
public class AbsStorageOperatorTest {
	...
	public void getResourceFullName() {
		final String expectedResourceFileName = String.format("dolphinscheduler/%s/resources/%s", TENANT_CODE_MOCK,
				FILE_NAME_MOCK);
	...
	public void testGetFileStatus() throws Exception {
		StorageEntity entity = absStorageOperator.getFileStatus(FULL_NAME, DEFAULT_PATH, TENANT_CODE_MOCK,
				ResourceType.FILE);
	...
	public void testListFilesStatus() throws Exception {
		...
		List<StorageEntity> result = absStorageOperator.listFilesStatus(FULL_NAME, DEFAULT_PATH, TENANT_CODE_MOCK,
				ResourceType.FILE);
	...
	public void testListFilesStatusRecursively() throws Exception {
		...
		List<StorageEntity> result = absStorageOperator.listFilesStatusRecursively(FULL_NAME, DEFAULT_PATH,
