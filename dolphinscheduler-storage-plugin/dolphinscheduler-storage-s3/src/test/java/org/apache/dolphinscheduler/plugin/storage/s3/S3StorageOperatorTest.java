...
public class S3StorageOperatorTest {
	...
	public void setUp() throws Exception {
		...
		doReturn(ACCESS_KEY_ID_MOCK).when(s3StorageOperator).readAccessKeyID();
		doReturn(ACCESS_KEY_SECRET_MOCK).when(s3StorageOperator).readAccessKeySecret();
		...
		Mockito.doReturn(s3Client).when(s3StorageOperator).buildS3Client();
		Mockito.doNothing().when(s3StorageOperator).checkBucketNameExists(Mockito.any());
	...
	public void getResourceFullName() {
		final String expectedResourceFullName = String.format("dolphinscheduler/%s/resources/%s", TENANT_CODE_MOCK,
				FILE_NAME_MOCK);
	...
	public void getResourceFileName() {
		...
		final String resourceFullName = String.format("dolphinscheduler/%s/resources/%s", TENANT_CODE_MOCK,
				FILE_NAME_MOCK);
	...
	public void getFileName() {
		final String expectedFileName = String.format("dolphinscheduler/%s/resources/%s", TENANT_CODE_MOCK,
				FILE_NAME_MOCK);
	...
	public void testGetFileStatus() throws Exception {
		...
		StorageEntity entity = s3StorageOperator.getFileStatus(FULL_NAME, DEFAULT_PATH, TENANT_CODE_MOCK,
				ResourceType.FILE);
	...
	public void testListFilesStatus() throws Exception {
		doReturn(new ListObjectsV2Result()).when(s3Client).listObjectsV2(Mockito.any(ListObjectsV2Request.class));
		List<StorageEntity> result = s3StorageOperator.listFilesStatus(FULL_NAME, DEFAULT_PATH, TENANT_CODE_MOCK,
				ResourceType.FILE);
	...
	public void testListFilesStatusRecursively() throws Exception {
		...
		List<StorageEntity> result = s3StorageOperator.listFilesStatusRecursively(FULL_NAME, DEFAULT_PATH,
