...
public interface ResourcesService {
	 ...
	 */
	Result<Object> createDirectory(User loginUser, String name, ResourceType type, int pid, String currentDir);
	 ...
	 */
	Result<Object> createResource(User loginUser, String name, ResourceType type, MultipartFile file,
			String currentDir);
	 ...
	 */
	Result<Object> updateResource(User loginUser, String fullName, String tenantCode, String name, ResourceType type,
			MultipartFile file);
	 ...
	 * ignored and directly create the new file
	 *
	 * @param userName
	 ...
	 */
	Result<Object> updateResourceContent(User loginUser, String fullName, String tenantCode, String content);
	...
	/**
	 * Get resource by given resource type and full name. Useful in Python API
	 * create task which need processDefinition information.
	 *
	 * @param userName
	 ...
	 *            resource full name
	 * @param tenantCode
	 *            owner's tenant code of resource
	 * @return resource
	 */
	Result<Object> queryResourceByFullName(User loginUser, String fullName, String tenantCode, ResourceType type)
			throws IOException;
