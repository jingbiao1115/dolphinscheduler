...
public class TaskInstanceV2Controller extends BaseController {
	 ...
	 * @param projectCode
	 *            project code
	 * @param taskInstanceQueryReq
	 *            taskInstanceQueryReq
	...
	public Result<PageInfo<TaskInstance>> queryTaskListPaging(
		...
		return taskInstanceService.queryTaskListPaging(loginUser, projectCode,
				...
				taskInstanceQueryReq.getProcessDefinitionName(), taskInstanceQueryReq.getTaskName(),
				taskInstanceQueryReq.getTaskCode(), taskInstanceQueryReq.getExecutorName(),
	...
	public TaskInstanceSuccessResponse forceTaskSuccess(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
			@PathVariable(value = "id") Integer id) {
	...
	public TaskInstance queryTaskInstanceByCode(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
