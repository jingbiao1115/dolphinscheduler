...
public class ProjectPreferenceServiceImpl extends BaseServiceImpl implements ProjectPreferenceService {
	...
	public Result updateProjectPreference(User loginUser, long projectCode, String preferences) {
		...
		ProjectPreference projectPreference = projectPreferenceMapper.selectOne(
				new QueryWrapper<ProjectPreference>().lambda().eq(ProjectPreference::getProjectCode, projectCode));
