...
public class AlertPluginInstanceController extends BaseController {
	...
	public Result<AlertPluginInstance> createAlertPluginInstance(
	...
	public Result<AlertPluginInstance> updateAlertPluginInstanceById(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@PathVariable(value = "id") int id, @RequestParam(value = "instanceName") String instanceName,
			@RequestParam(value = "warningType") WarningType warningType,
			@RequestParam(value = "pluginInstanceParams") String pluginInstanceParams) {
		AlertPluginInstance alertPluginInstance = alertPluginInstanceService.updateById(loginUser, id, instanceName,
				warningType, pluginInstanceParams);
		return Result.success(alertPluginInstance);
	}
	...
	public Result<Boolean> deleteAlertPluginInstance(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
	...
	public Result<AlertPluginInstance> getAlertPluginInstance(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@PathVariable(value = "id") int id) {
	...
	public Result<List<AlertPluginInstanceVO>> getAlertPluginInstance(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser) {
	...
	public Result<PageInfo<AlertPluginInstanceVO>> listPaging(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@RequestParam(value = "searchVal", required = false) String searchVal,
			@RequestParam("pageNo") Integer pageNo, @RequestParam("pageSize") Integer pageSize) {
		checkPageParams(pageNo, pageSize);
		searchVal = ParameterUtils.handleEscapes(searchVal);
		PageInfo<AlertPluginInstanceVO> alertPluginInstanceVOPageInfo = alertPluginInstanceService.listPaging(loginUser,
