...
public class AccessTokenV2Controller extends BaseController {
	...
	public Result<AccessToken> createToken(
		...
		AccessToken accessToken = accessTokenService.createToken(loginUser, createTokenRequest.getUserId(),
				createTokenRequest.getExpireTime(), createTokenRequest.getToken());
