...
public class TaskCreateRequest {
	...
	public TaskDefinition convert2TaskDefinition() {
		...
		TimeoutFlag timeoutFlagCreate = this.timeoutFlag == null
				? TimeoutFlag.CLOSE
				: TimeoutFlag.valueOf(this.timeoutFlag);
		...
		TaskTimeoutStrategy taskTimeoutStrategyCreate = this.timeoutNotifyStrategy == null
