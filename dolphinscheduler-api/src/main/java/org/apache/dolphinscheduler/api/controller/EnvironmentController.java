...
public class EnvironmentController extends BaseController {
	...
	public Result<Long> createEnvironment(
	...
	public Result<Environment> updateEnvironment(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@RequestParam("code") Long code, @RequestParam("name") String name, @RequestParam("config") String config,
			@RequestParam(value = "description", required = false) String description,
			@RequestParam(value = "workerGroups", required = false) String workerGroups) {
		Environment environment = environmentService.updateEnvironmentByCode(loginUser, code, name, config, description,
				workerGroups);
	...
	public Result queryEnvironmentByCode(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
	...
	public Result queryEnvironmentListPaging(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
	...
	public Result deleteEnvironment(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@RequestParam("environmentCode") Long environmentCode) {
	...
	@ResponseStatus(HttpStatus.OK)
	@ApiException(QUERY_ENVIRONMENT_ERROR)
	public Result queryAllEnvironmentList(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser) {
	...
	public Result verifyEnvironment(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
