...
public class DqExecuteResultServiceImpl extends BaseServiceImpl implements DqExecuteResultService {
	...
	@Override
	public PageInfo<DqExecuteResult> queryResultListPaging(User loginUser, String searchVal, Integer state,
			Integer ruleType, String startTime, String endTime, Integer pageNo, Integer pageSize) {
		...
		IPage<DqExecuteResult> dqsResultPage = dqExecuteResultMapper.queryResultListPaging(page, searchVal, loginUser,
				statusArray, ruleType, start, end);

		int total = (int) dqsResultPage.getTotal();
