...
public class AuditLogController extends BaseController {
	...
	public Result<PageInfo<AuditDto>> queryAuditLogListPaging(
		...
		PageInfo<AuditDto> auditDtoPageInfo = auditService.queryLogListPaging(loginUser, resourceType, operationType,
				startDate, endDate, userName, pageNo, pageSize);
