...
public class TaskInstanceCountVO {
	...
	public static TaskInstanceCountVO of(List<TaskInstanceStatusCountDto> taskInstanceStatusCounts) {
		...
		Map<TaskExecutionStatus, TaskInstanceStatusCountDto> taskInstanceStatusCountMap = taskInstanceStatusCounts
				.stream().collect(Collectors.toMap(TaskInstanceStatusCountDto::getState, Function.identity()));
