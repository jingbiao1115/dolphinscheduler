...
/**
 * Swagger configuration, only enabled when the configuration item
 * api.swagger.enable is true. The swagger ui is under <a href=
 * "http://${host}:${port}/dolphinscheduler/swagger-ui.html">http://${host}:${port}/dolphinscheduler/swagger-ui.html</a>
 */
@Configuration
...
public class SwaggerConfiguration implements WebMvcConfigurer {
	...
	public OpenAPI openAPI() {
		Info info = new Info().title("Apache DolphinScheduler Api Docs").description("Apache DolphinScheduler Api Docs")
