...
public class ProcessTaskRelationV2Controller extends BaseController {
	 ...
	 *            process task definition json contains the object you want to
	 *            create
	...
	public Result<ProcessTaskRelation> createTaskRelation(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
			@RequestBody TaskRelationCreateRequest TaskRelationCreateRequest) {
		ProcessTaskRelation processTaskRelation = processTaskRelationService.createProcessTaskRelationV2(loginUser,
	 ...
	 *            login user
	 * @param codePair
	 *            code pair you want to delete the task relation, use
	 *            `upstream,downstream` as example, will delete exists relation
	 *            upstream -> downstream, throw error if not exists
	...
	public Result deleteTaskRelation(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
	 ...
	 *            login user
	 * @param code
	 *            resource task code want to update its upstreams
	...
	public Result<List<ProcessTaskRelation>> updateUpstreamTaskDefinition(
			@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
