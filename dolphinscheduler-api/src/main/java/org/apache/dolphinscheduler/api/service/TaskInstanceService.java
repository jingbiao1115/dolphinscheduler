...
public interface TaskInstanceService {
	 ...
	 */
	Result queryTaskListPaging(User loginUser, long projectCode, Integer processInstanceId, String processInstanceName,
			String processDefinitionName, String taskName, Long taskCode, String executorName, String startDate,
			String endDate, String searchVal, TaskExecutionStatus stateType, String host,
	 ...
	 */
	Result forceTaskSuccess(User loginUser, long projectCode, Integer taskInstanceId);
