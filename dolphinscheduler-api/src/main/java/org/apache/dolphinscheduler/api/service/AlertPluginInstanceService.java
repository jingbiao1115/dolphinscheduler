...
public interface AlertPluginInstanceService {
	 ...
	 * @return result
	 */
	AlertPluginInstance create(User loginUser, int pluginDefineId, String instanceName,
	 ...
	 * @return result
	 */
	AlertPluginInstance updateById(User loginUser, int alertPluginInstanceId, String instanceName,
