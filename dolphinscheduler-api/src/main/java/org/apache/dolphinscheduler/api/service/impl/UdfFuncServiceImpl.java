...
public class UdfFuncServiceImpl extends BaseServiceImpl implements UdfFuncService {
	...
	@Override
	@Transactional
	public Result<Object> createUdfFunction(User loginUser, String funcName, String className, String fullName,
			String argTypes, String database, String desc, UdfType type) {
		...
		// set resourceId to -1 because we do not store resource to db anymore, instead
		// we use fullName
		udf.setResourceId(-1);
	 ...
	 */
	@Override
	public Result<Object> updateUdfFunc(User loginUser, int udfFuncId, String funcName, String className,
			String argTypes, String database, String desc, UdfType type, String fullName) {
		Result<Object> result = new Result<>();
