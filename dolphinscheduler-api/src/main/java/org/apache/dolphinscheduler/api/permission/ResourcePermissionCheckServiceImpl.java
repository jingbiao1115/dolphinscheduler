...
public class ResourcePermissionCheckServiceImpl
	...
	@Override
	public boolean operationPermissionCheck(Object authorizationType, Integer userId, String permissionKey,
			Logger logger) {
	...
	public Set<Object> userOwnedResourceIdsAcquisition(Object authorizationType, Integer userId, Logger logger) {
		...
		return (Set<Object>) RESOURCE_LIST_MAP.get(authorizationType)
				.listAuthorizedResourceIds(user.getUserType().equals(UserType.ADMIN_USER) ? 0 : userId, logger);
	}
