...
public enum RedshiftAuthMode {
	...
	PASSWORD(0, "password"), IAM_ACCESS_KEY(1, "IAM-accessKey"),;

	private static final Map<Integer, RedshiftAuthMode> AUTH_TYPE_MAP = Arrays.stream(RedshiftAuthMode.values())
			.collect(toMap(RedshiftAuthMode::getCode, Functions.identity()));
