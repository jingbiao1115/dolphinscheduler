...
public class RedshiftDataSourceProcessor extends AbstractDataSourceProcessor {
	...
	public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
		...
		if (redshiftConnectionParam.getMode().equals(RedshiftAuthMode.PASSWORD)) {
			return DriverManager.getConnection(getJdbcUrl(connectionParam), redshiftConnectionParam.getUser(),
	...
	/**
	 * 2 auth mode PASSWORD: address example:
	 * jdbc:redshift://examplecluster.abc123xyz789.us-west-2.redshift.amazonaws.com:5439
	 * IAM_ACCESS_KEY: address example1:
	 * jdbc:redshift:iam://examplecluster:us-west-2 address example2:
	 ...
	 * IAM_ACCESS_KEY: address example1:
	 * jdbc:redshift:iam://examplecluster:us-west-2/dev?AccessKeyID=xxx&SecretAccessKey=xxx&DbUser=kristen
	 * address example2:
	 * jdbc:redshift:iam://examplecluster.abc123xyz789.us-west-2.redshift.amazonaws.com:5439/dev?AccessKeyID=xxx&SecretAccessKey=xxx&DbUser=kristen
	 *
	...
	public static Connection getConnectionByIAM(RedshiftConnectionParam redshiftConnectionParam) {
		...
		if (MapUtils.isNotEmpty(redshiftConnectionParam.getOther())) {
			...
			// if none other params map, basic will be
