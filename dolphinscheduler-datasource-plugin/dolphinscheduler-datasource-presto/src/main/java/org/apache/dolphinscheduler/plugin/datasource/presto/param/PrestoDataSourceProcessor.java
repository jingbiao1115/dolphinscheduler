...
public class PrestoDataSourceProcessor extends AbstractDataSourceProcessor {
	...
	public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO datasourceParam) {
		...
		String address = String.format("%s%s:%s", DataSourceConstants.JDBC_PRESTO, prestoParam.getHost(),
				prestoParam.getPort());
	...
	public String getJdbcUrl(ConnectionParam connectionParam) {
		...
		/**
		 * return jdbc url without other parameters, avoid to assign same parameters
		 * both in URL and properties. or else got error msg: Connection property '...'
		 * is both in the URL and an argument ref to
		 * <a href="https://prestodb.io/docs/current/installation/jdbc.html">Presto JDBC
		 * Driver</>
		 */
	...
	public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
		...
		return DriverManager.getConnection(getJdbcUrl(connectionParam), prestoConnectionParam.getUser(),
				PasswordUtils.decodePassword(prestoConnectionParam.getPassword()));
	}
