...
public class AthenaDataSourceProcessor extends AbstractDataSourceProcessor {
	...
	public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO datasourceParam) {
		...
		String address = String.format("%s%s=%s;", DataSourceConstants.JDBC_ATHENA, "AwsRegion",
				athenaParam.getAwsRegion());
	...
	public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
		...
		return DriverManager.getConnection(this.getJdbcUrl(connectionParam), athenaConnectionParam.getUser(),
				PasswordUtils.decodePassword(athenaConnectionParam.getPassword()));
	}
