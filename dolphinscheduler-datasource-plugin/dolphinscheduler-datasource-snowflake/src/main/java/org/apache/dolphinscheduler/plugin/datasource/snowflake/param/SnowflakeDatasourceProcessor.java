...
public class SnowflakeDatasourceProcessor extends AbstractDataSourceProcessor {
	...
	public BaseDataSourceParamDTO createDatasourceParamDTO(String connectionJson) {
		SnowflakeConnectionParam snowFlakeConnectionParam = (SnowflakeConnectionParam) createConnectionParams(
				connectionJson);
	...
	public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
		...
		return DriverManager.getConnection(getJdbcUrl(connectionParam), snowFlakeConnectionParam.getUser(),
