...
public class SshClientWrapper implements AutoCloseable {
	...
	public SshClientWrapper(String ip, Integer port, String userName, String password, String privateKey)
	...
	public void close() throws Exception {
		try (ClientSession clientSession1 = clientSession; SshClient sshClient1 = sshClient) {
