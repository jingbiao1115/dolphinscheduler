...
public class SSHDataSourceProcessorTest {
	...
	private String connectJson = "{\"user\":\"lucky\",\"password\":\"123456\",\"host\":\"dolphinscheduler.com\",\"port\":22, \"publicKey\":\"ssh-rsa AAAAB\"}";
	...
	void testCreateDatasourceParamDTO() {
		SSHDataSourceParamDTO sshDataSourceParamDTO = (SSHDataSourceParamDTO) sshDataSourceProcessor
	...
	void testTestConnection() {
		...
		try (MockedConstruction<SshClientWrapper> sshClientWrapperMockedConstruction = Mockito
				.mockConstruction(SshClientWrapper.class, (mock, context) -> {
