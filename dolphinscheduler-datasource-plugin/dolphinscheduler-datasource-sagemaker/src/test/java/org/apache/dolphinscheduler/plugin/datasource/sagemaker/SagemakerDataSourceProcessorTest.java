...
public class SagemakerDataSourceProcessorTest {
	...
	private String connectJson = "{\"userName\":\"access key\",\"password\":\"secret access key\",\"awsRegion\":\"region\"}";
	...
	void testCreateDatasourceParamDTO() {
		SagemakerDataSourceParamDTO sagemakerDataSourceParamDTO = (SagemakerDataSourceParamDTO) sagemakerDataSourceProcessor
	...
	void testCreateConnectionParams() {
		SagemakerDataSourceParamDTO sagemakerDataSourceParamDTO = (SagemakerDataSourceParamDTO) sagemakerDataSourceProcessor
				.createDatasourceParamDTO(connectJson);
		SagemakerConnectionParam sagemakerConnectionParam = sagemakerDataSourceProcessor
				.createConnectionParams(sagemakerDataSourceParamDTO);
	...
	void testTestConnection() {
		SagemakerDataSourceParamDTO sagemakerDataSourceParamDTO = (SagemakerDataSourceParamDTO) sagemakerDataSourceProcessor
				.createDatasourceParamDTO(connectJson);
		SagemakerConnectionParam connectionParam = sagemakerDataSourceProcessor
				.createConnectionParams(sagemakerDataSourceParamDTO);
		Assertions.assertFalse(sagemakerDataSourceProcessor.checkDataSourceConnectivity(connectionParam));

		try (MockedConstruction<SagemakerClientWrapper> sshClientWrapperMockedConstruction = Mockito
				.mockConstruction(SagemakerClientWrapper.class, (mock, context) -> {
					Mockito.when(mock.checkConnect()).thenReturn(true);
				})) {
