...
public class TrinoDataSourceProcessor extends AbstractDataSourceProcessor {
	...
	public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO datasourceParam) {
		...
		String address = String.format("%s%s:%s", DataSourceConstants.JDBC_TRINO, TrinoParam.getHost(),
				TrinoParam.getPort());
	...
	public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
		...
		return DriverManager.getConnection(getJdbcUrl(connectionParam), TrinoConnectionParam.getUser(),
				PasswordUtils.decodePassword(TrinoConnectionParam.getPassword()));
	}
