...
public enum AzureSQLAuthMode {
	...
	SQL_PASSWORD(0, "SqlPassword"), AD_PASSWORD(1, "ActiveDirectoryPassword"), AD_MSI(2,
			"ActiveDirectoryMSI"), AD_SERVICE_PRINCIPAL(3,
					"ActiveDirectoryServicePrincipal"), ACCESSTOKEN(4, "accessToken"),;

	private static final Map<Integer, AzureSQLAuthMode> AUTH_TYPE_MAP = Arrays.stream(AzureSQLAuthMode.values())
			.collect(toMap(AzureSQLAuthMode::getCode, Functions.identity()));
