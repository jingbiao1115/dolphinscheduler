...
/**
 * Basic datasource params submitted to api, each datasource plugin should have
 * implementation.
 */
public abstract class BaseDataSourceParamDTO implements Serializable {
	...
	/**
	 * extract the host and port from the address, then set it
	 * 
	 * @param address
	 *            address like 'jdbc:mysql://host:port' or
	 *            'jdbc:hive2://zk1:port,zk2:port,zk3:port'
	 */
	public void setHostAndPortByAddress(String address) {
		...
		String hostPortString = slashIndex == -1
				? address.substring(doubleSlashIndex + 2)
	...
	/**
	 * Get the datasource type see{@link DbType}
	 *
