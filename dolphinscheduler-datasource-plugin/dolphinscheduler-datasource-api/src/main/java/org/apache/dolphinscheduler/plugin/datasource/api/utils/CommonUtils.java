...
public class CommonUtils {
	...
	public static boolean loadKerberosConf(Configuration configuration) throws IOException {
		return loadKerberosConf(PropertyUtils.getString(JAVA_SECURITY_KRB5_CONF_PATH),
				PropertyUtils.getString(LOGIN_USER_KEY_TAB_USERNAME), PropertyUtils.getString(LOGIN_USER_KEY_TAB_PATH),
				configuration);
	}
	 ...
	 * load kerberos configuration
	 *
	 * @param javaSecurityKrb5Conf
	 *            javaSecurityKrb5Conf
	 * @param loginUserKeytabUsername
	 *            loginUserKeytabUsername
	 * @param loginUserKeytabPath
	 *            loginUserKeytabPath
	 * @throws IOException
	 *             errors
	 */
	...
	public static String getHdfsDataBasePath() {
		...
		if ("/".equals(resourceUploadPath)) {
			// if basepath is configured to /, the generated url may be //default/resources
			// (with extra leading /)
			return "";
		} else {
