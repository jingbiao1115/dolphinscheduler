...
public class DataSourceClientProvider {
	...
	private static final Cache<String, PooledDataSourceClient> POOLED_DATASOURCE_CLIENT_CACHE = CacheBuilder
			.newBuilder()
	...
	public static DataSourceClient getPooledDataSourceClient(DbType dbType, ConnectionParam connectionParam)
	...
	public static Connection getAdHocConnection(DbType dbType, ConnectionParam connectionParam)
			throws SQLException, ExecutionException {
