...
public class UserGroupInformationFactory {
	...
	private static final ScheduledExecutorService kerberosRenewalService = ThreadUtils
			.newSingleDaemonScheduledExecutorService("Hive-Kerberos-Renewal-Thread-");
	...
	private static UserGroupInformation createKerberosUser() {
		...
		try {
			...
			UserGroupInformation userGroupInformation = UserGroupInformation
					.loginUserFromKeytabAndReturnUGI(principal.trim(), keytab.trim());
