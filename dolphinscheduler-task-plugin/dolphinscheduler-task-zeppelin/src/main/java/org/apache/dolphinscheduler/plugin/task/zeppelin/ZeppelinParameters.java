...
public class ZeppelinParameters extends AbstractParameters {
	 ...
	 * 
	 * @see <a href=
	 *      "https://zeppelin.apache.org/docs/0.9.0/usage/zeppelin_sdk/client_api.html">Zeppelin_Client_API_Examples</a>
	 */
	...
	public ZeppelinTaskExecutionContext generateExtendedContext(ResourceParametersHelper parametersHelper) {
		DataSourceParameters dataSourceParameters = (DataSourceParameters) parametersHelper
