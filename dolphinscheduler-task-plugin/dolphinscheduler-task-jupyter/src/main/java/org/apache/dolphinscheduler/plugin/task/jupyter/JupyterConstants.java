...
public class JupyterConstants {
	 ...
	 */
	public static final String CREATE_ENV_FROM_TAR = "mkdir jupyter_env && " + "tar -xzf %s -C jupyter_env && "
	...
	public static final String CREATE_ENV_FROM_TXT = "conda create -n jupyter-tmp-env-%s -y && "
			+ "conda activate jupyter-tmp-env-%s && " + "pip install -r %s";
	...
	/**
	 * Time in seconds to wait for each cell before failing execution (default:
	 * forever)
	 */
	...
	/**
	 * Insert the paths of input/output notebooks as
	 * PAPERMILL_INPUT_PATH/PAPERMILL_OUTPUT_PATH as notebook parameters.
	 */
