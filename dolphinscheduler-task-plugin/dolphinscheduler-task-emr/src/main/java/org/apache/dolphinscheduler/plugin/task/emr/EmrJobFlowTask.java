...
public class EmrJobFlowTask extends AbstractEmrTask {
	...
	private final HashSet<String> waitingStateSet = Sets.newHashSet(ClusterState.STARTING.toString(),
			ClusterState.BOOTSTRAPPING.toString(), ClusterState.RUNNING.toString());
	...
	public void submitApplication() throws TaskException {
		...
		try {
			...
			// supports failover on yarn task
