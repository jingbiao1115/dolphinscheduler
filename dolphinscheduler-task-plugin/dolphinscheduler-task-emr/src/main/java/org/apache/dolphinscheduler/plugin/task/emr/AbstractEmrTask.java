...
public abstract class AbstractEmrTask extends AbstractRemoteTask {
	...
	/**
	 * config ObjectMapper features and propertyNamingStrategy use
	 * UpperCamelCaseStrategy support capital letters parse
	 *
	 * @see PropertyNamingStrategy.UpperCamelCaseStrategy
	 */
	static final ObjectMapper objectMapper = new ObjectMapper().configure(FAIL_ON_UNKNOWN_PROPERTIES, false)
	...
	protected AmazonElasticMapReduce createEmrClient() {
		...
		return AmazonElasticMapReduceClientBuilder.standard().withCredentials(awsCredentialsProvider)
