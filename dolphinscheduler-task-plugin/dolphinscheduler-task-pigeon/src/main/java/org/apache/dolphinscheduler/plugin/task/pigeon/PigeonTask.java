...
public class PigeonTask extends AbstractRemoteTask {
	...
	public void handle(TaskCallBack taskCallBack) throws TaskException {
		...
		try {
			...
			log.info("PIGEON task: {},taskId:{} costTime : {} milliseconds, statusCode : {}", targetJobName, taskId,
					costTime, (execState == ExecResult.SUCCESS) ? "'success'" : "'failure'");
	...
	public void cancelApplication() throws TaskException {
		...
		StringEntity entity = new StringEntity(config.getJobCancelPostBody(triggerResult.getTaskId()),
	...
	private <T extends AjaxResult> T processResponse(String applyUrl, CloseableHttpResponse response, Class<T> clazz)
			throws Exception {
