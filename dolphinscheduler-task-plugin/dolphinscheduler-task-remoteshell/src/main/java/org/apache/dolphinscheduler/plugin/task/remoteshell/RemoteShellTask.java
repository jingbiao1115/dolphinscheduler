...
public class RemoteShellTask extends AbstractTask {
	...
	public void initRemoteExecutor() {
		...
		SSHConnectionParam sshConnectionParam = (SSHConnectionParam) DataSourceUtils
				.buildConnectionParams(DbType.valueOf(remoteShellParameters.getType()), dbSource.getConnectionParams());
