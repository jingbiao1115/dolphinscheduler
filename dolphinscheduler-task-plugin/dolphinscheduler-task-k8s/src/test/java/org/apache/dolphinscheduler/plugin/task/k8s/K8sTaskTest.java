...
public class K8sTaskTest {
	...
	private final List<NodeSelectorExpression> nodeSelectorExpressions = Arrays
			.asList(new NodeSelectorExpression("node-label", "In", "1234,12345"));
	...
	public void testConvertToNodeSelectorRequirements() {
		...
		List<NodeSelectorRequirement> nodeSelectorRequirements = k8sTask
				.convertToNodeSelectorRequirements(Arrays.asList(expression));
