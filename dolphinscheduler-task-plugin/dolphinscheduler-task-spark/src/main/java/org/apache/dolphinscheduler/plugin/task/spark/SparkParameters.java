...
public class SparkParameters extends AbstractParameters {
	...
	/**
	 * program type 0 JAVA,1 SCALA,2 PYTHON,3 SQL
	 */
	...
	public boolean checkParameters() {
		/**
		 * When saving a task, the parameters cannot be empty and mainJar or rawScript
		 * cannot be empty: (1) When ProgramType is SQL, rawScript cannot be empty. (2)
		 * When ProgramType is Java/Scala/Python, mainJar cannot be empty.
		 */
