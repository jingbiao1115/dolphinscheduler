...
public class FlinkArgsUtils {
	...
	/**
	 * build flink savepoint command line, the savepoint folder should be set in
	 * flink conf
	 * 
	 * @return
	 */
	...
	public static List<String> buildInitOptionsForSql(FlinkParameters flinkParameters) {
		...
		FlinkDeployMode deployMode = Optional.ofNullable(flinkParameters.getDeployMode())
				.orElse(FlinkDeployMode.CLUSTER);
	...
	private static List<String> buildRunCommandLineForOthers(TaskExecutionContext taskExecutionContext,
		...
		// If the job is submitted in attached mode, perform a best-effort cluster
