...
public class SeatunnelSparkTask extends SeatunnelTask {
	...
	@Override
	public void init() {
		seatunnelParameters = JSONUtils.parseObject(taskExecutionContext.getTaskParams(),
	...
	public List<String> buildOptions() throws Exception {
		...
		MasterTypeEnum master = DeployModeEnum.local == seatunnelParameters.getDeployMode()
				? MasterTypeEnum.LOCAL
