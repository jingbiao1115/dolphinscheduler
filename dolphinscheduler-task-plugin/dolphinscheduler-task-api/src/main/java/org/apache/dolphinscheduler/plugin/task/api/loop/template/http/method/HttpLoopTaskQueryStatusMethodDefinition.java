...
public class HttpLoopTaskQueryStatusMethodDefinition extends HttpLoopTaskMethodDefinition
	...
	public HttpLoopTaskQueryStatusMethodDefinition(String url, String httpMethodType, String dataType,
		...
		try {
			if (StringUtils.equalsIgnoreCase("get", httpMethodType)) {
				...
				throw new IllegalArgumentException(
						String.format("http method type: %s is not supported", httpMethodType));
			}
