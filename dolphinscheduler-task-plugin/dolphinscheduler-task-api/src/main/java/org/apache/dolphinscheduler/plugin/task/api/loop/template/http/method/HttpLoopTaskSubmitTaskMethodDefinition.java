...
public class HttpLoopTaskSubmitTaskMethodDefinition extends HttpLoopTaskMethodDefinition
	...
	public HttpLoopTaskSubmitTaskMethodDefinition(String url, String httpMethodType, String dataType,
			Map<String, String> httpHeaders, Map<String, Object> requestParams, Map<String, Object> requestBody,
	...
	public @NonNull LoopTaskInstanceInfo submitLoopTask() {
		...
		try {
			if (StringUtils.equalsIgnoreCase(httpMethodType, "GET")) {
				...
				throw new IllegalArgumentException(
						String.format("The request method type: %s is not supported.", httpMethodType));
			}
		...
		String taskInstanceId = taskInstanceIdOptional.orElseThrow(() -> new RuntimeException(
				String.format("Resolve the taskInstanceId error, responseBody: %s, taskInstanceIdJPath: %s",
						responseBody, taskInstanceIdJPath)));
