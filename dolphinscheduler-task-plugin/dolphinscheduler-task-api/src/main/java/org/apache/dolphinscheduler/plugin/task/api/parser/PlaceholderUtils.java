...
public class PlaceholderUtils {
	...
	public static String replacePlaceholders(String value, Map<String, String> paramsMap,
		...
		// replacement tool， parameter key will be replaced by value,if can't match ,
		// will throw an exception
		PropertyPlaceholderHelper strictHelper = getPropertyPlaceholderHelper(false);

		// Non-strict replacement tool implementation, when the position to be replaced
		// does not get the corresponding
