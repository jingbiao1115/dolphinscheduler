...
public class TaskUtils {
	...
	// todo: Add to SPI
	private final Set<String> MASTER_TASK_TYPES = Sets.newHashSet(blockingLogicTask, conditionLogicTask,
			dependentLogicTask, subWorkflowLogicTask, switchLogicTask, dynamicLogicTask);
