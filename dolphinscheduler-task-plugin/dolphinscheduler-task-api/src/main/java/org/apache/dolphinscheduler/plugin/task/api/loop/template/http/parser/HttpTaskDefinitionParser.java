...
public class HttpTaskDefinitionParser implements TaskDefinitionParser<HttpLoopTaskDefinition> {
	...
	public @NonNull HttpLoopTaskDefinition parse(@NonNull String yamlConfigFile) {
		...
		HttpLoopTaskSubmitTaskMethodDefinition submitTaskMethod = new SubmitTemplateMethodTransformer()
				.transform(api.getSubmit());
		HttpLoopTaskQueryStatusMethodDefinition queryTaskStateMethod = new QueryStateTemplateMethodTransformer()
				.transform(api.getQueryState());
		HttpLoopTaskCancelTaskMethodDefinition cancelTaskMethod = new CancelTemplateMethodTransformer()
				.transform(api.getCancel());
