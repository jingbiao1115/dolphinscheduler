...
public enum CheckType {
	...
	/**
	 * 0-comparison_minus_statistics 1-statistics_minus_comparison
	 * 2-statistics_comparison_percentage
	 * 3-statistics_comparison_difference_comparison_percentage
	 */
	COMPARISON_MINUS_STATISTICS(0, "comparison_minus_statistics"), STATISTICS_MINUS_COMPARISON(1,
			"statistics_minus_comparison"), STATISTICS_COMPARISON_PERCENTAGE(2,
					"statistics_comparison_percentage"), STATISTICS_COMPARISON_DIFFERENCE_COMPARISON_PERCENTAGE(3,
