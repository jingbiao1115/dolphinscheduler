...
public abstract class BaseLoopTaskExecutor extends AbstractRemoteTask {
	...
	public void handle(TaskCallBack taskCallBack) throws TaskException {
		try {
			...
			// we use retry utils here to avoid the task status query failure due to network
			// failure.
	 ...
	 */
	public abstract @NonNull LoopTaskInstanceStatus queryTaskInstanceStatus(
			@NonNull LoopTaskInstanceInfo taskInstanceInfo) throws TaskException;
