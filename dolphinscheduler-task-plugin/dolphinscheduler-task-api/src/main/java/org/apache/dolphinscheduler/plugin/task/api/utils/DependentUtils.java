...
public class DependentUtils {
	 ...
	 *
	 * @param dependItemVarPoolPropertyMap
	 *            dependItemVarPoolPropertyMap
	 * @param dependItemVarPoolEndTimeMap
	 *            dependItemVarPoolEndTimeMap
	 * @param dependTaskVarPoolPropertyMap
	 *            dependTaskVarPoolPropertyMap
	 * @param dependTaskVarPoolEndTimeMap
	 *            dependTaskVarPoolEndTimeMap
	 */
	public static void addTaskVarPool(Map<String, Property> dependItemVarPoolPropertyMap,
			Map<String, Long> dependItemVarPoolEndTimeMap, Map<String, Property> dependTaskVarPoolPropertyMap,
