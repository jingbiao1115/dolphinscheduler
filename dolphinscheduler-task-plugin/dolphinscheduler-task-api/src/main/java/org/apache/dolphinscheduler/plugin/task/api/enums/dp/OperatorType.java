...
public enum OperatorType {
	...
	/**
	 * 0-equal 1-little than 2-little and equal 3-great than 4-great and equal 5-not
	 * equal
	 */
	EQ(0, "equal"), LT(1, "little than"), LE(2, "little and equal"), GT(3, "great than"), GE(4,
			"great and equal"), NE(5, "not equal");
