...
public enum OptionSourceType {
	...
	/**
	 * 0-default 1-datasource_id 2-datasource_type 3-comparison_type
	 */
	DEFAULT(0, "default"), DATASOURCE_ID(1, "datasource_id"), DATASOURCE_TYPE(2, "datasource_type"), COMPARISON_TYPE(3,
			"comparison_type");
