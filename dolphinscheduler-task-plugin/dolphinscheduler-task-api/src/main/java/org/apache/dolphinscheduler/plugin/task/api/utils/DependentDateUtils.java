...
public class DependentDateUtils {
	 ...
	 * @return DateInterval list
	 */
	public static List<DateInterval> getNeededMonthBeginInterval(Date businessDate, boolean isBeginDay,
			int neededMonth) {
	...
	/**
	 * get interval between monday to sunday of last week default set monday the
	 * first day of week
	 * 
	 * @param businessDate
	 *            businessDate
	...
	/**
	 * get interval on the day of last week default set monday the first day of week
	 * 
	 * @param businessDate
	 *            businessDate
	 * @param dayOfWeek
