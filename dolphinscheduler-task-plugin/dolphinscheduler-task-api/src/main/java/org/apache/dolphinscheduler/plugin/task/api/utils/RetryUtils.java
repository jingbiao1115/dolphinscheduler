...
public class RetryUtils {
	...
	/**
	 * Retry to execute the given function with the given retry policy, the retry
	 * policy is used to defined retryTimes and retryInterval. This method will
	 * sleep for retryInterval when execute given supplier failure.
	 */
	...
	public static final class RetryPolicy {
		...
		/**
		 * The retry interval, if the give function is failed, will sleep the retry
		 * interval milliseconds and retry again.
		 */
