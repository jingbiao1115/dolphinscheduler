...
public class CancelTemplateMethodTransformer
	...
	@Override
	public @NonNull HttpLoopTaskCancelTaskMethodDefinition transform(
			@NonNull LoopTaskYamlDefinition.LoopTaskCancelYamlDefinition loopTaskAPIYamlDefinition) {
		...
		return new HttpLoopTaskCancelTaskMethodDefinition(url, method, dataType, httpHeaders, requestParams,
				requestBody);
	}
}
