...
/**
 * DataQualityConfiguration The reader is responsible for connecting to the data
 * source, and the transformer is responsible for transformer the data that from
 * reader, and the writer is responsible for writing data to the target
 * datasource
 */
public class DataQualityConfiguration {
	...
	public DataQualityConfiguration(String name, List<BaseConfig> readerConfigs, List<BaseConfig> writerConfigs,
	...
	public DataQualityConfiguration(String name, EnvConfig envConfig, List<BaseConfig> readerConfigs,
			List<BaseConfig> writerConfigs, List<BaseConfig> transformerConfigs) {
		this.name = name;
	...
	public String toString() {
		return "DataQualityConfiguration{" + "name='" + name + '\'' + ", envConfig=" + envConfig + ", readerConfigs="
				+ readerConfigs + ", transformerConfigs=" + transformerConfigs + ", writerConfigs=" + writerConfigs
				+ '}';
	}
}
