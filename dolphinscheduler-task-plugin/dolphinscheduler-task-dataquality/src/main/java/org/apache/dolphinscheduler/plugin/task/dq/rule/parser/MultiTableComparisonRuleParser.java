...
public class MultiTableComparisonRuleParser implements IRuleParser {
	...
	public DataQualityConfiguration parse(Map<String, String> inputParameterValue,
		...
		List<BaseConfig> writerConfigList = RuleParserUtils.getWriterConfigList(ParameterUtils
				.convertParameterPlaceholders(RuleManager.MULTI_TABLE_COMPARISON_WRITER_SQL, inputParameterValue),
				context);
