...
/**
 * IRuleParser is a component that actually converts input parameters to
 * DataQualityConfiguration
 */
public interface IRuleParser {

	DataQualityConfiguration parse(Map<String, String> inputParameterValue, DataQualityTaskExecutionContext context)
