	...
	public boolean checkParameters() {
		...
		switch (dvcTaskType) {
			case DvcConstants.DVC_TASK_TYPE.UPLOAD :
				return StringUtils.isNotEmpty(dvcRepository) && StringUtils.isNotEmpty(dvcDataLocation)
						&& StringUtils.isNotEmpty(dvcLoadSaveDataPath) && StringUtils.isNotEmpty(dvcVersion)
			...
			case DvcConstants.DVC_TASK_TYPE.INIT :
				return StringUtils.isNotEmpty(dvcRepository) && StringUtils.isNotEmpty(dvcStoreUrl);
