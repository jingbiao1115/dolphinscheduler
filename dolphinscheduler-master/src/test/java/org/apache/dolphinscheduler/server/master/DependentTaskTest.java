...
// getDependentItemFromTaskNode(2L, DEPEND_TASK_CODE_A, "today",
// "day")).collect(Collectors.toList()));
//
...
// getProcessInstanceForFindLastRunningProcess(200,
...
// getTaskInstanceForValidTaskList(2000, TaskExecutionStatus.SUCCESS,
// DEPEND_TASK_CODE_A,
// dependentProcessInstance),
// getTaskInstanceForValidTaskList(2000, TaskExecutionStatus.FAILURE,
// DEPEND_TASK_CODE_B,
// dependentProcessInstance))
...
// getDependentItemFromTaskNode(3L, DEPEND_TASK_CODE_B, "today",
// "day")).collect(Collectors.toList()));
//
...
// getDependentItemFromTaskNode(2L, DEPEND_TASK_CODE_A, "today", "day"),
// getDependentItemFromTaskNode(3L, DEPEND_TASK_CODE_C, "today",
// "day")).collect(Collectors.toList()));
//
// /*
...
// getProcessInstanceForFindLastRunningProcess(300,
// WorkflowExecutionStatus.SUCCESS);
//
// // for DependentExecute.findLastProcessInterval
// Mockito.when(processInstanceDao
...
// .thenReturn(Stream.of(
// getTaskInstanceForValidTaskList(3000, TaskExecutionStatus.SUCCESS,
// DEPEND_TASK_CODE_B,
// processInstance300),
// getTaskInstanceForValidTaskList(3001, TaskExecutionStatus.SUCCESS,
// DEPEND_TASK_CODE_C,
// processInstance300))
// .collect(Collectors.toList()));
//
...
// dependentTaskModel.setRelation(DependentRelation.AND);
// dependentTaskModel.setDependItemList(Stream.of(
// getDependentItemFromTaskNode(2L, Constants.DEPENDENT_ALL_TASK_CODE, "today",
// "day"))
// .collect(Collectors.toList()));
//
// DependentParameters dependentParameters = new DependentParameters();
...
// .findLastRunningProcess(Mockito.eq(2L), Mockito.any(), Mockito.any(),
// Mockito.anyInt()))
// .thenReturn(getProcessInstanceForFindLastRunningProcess(200,
// WorkflowExecutionStatus.SUCCESS));
//
// }
//
...
// // for the poor independence of UT, error on other place may causes the
// condition happens
...
// .thenReturn(dependentProcessInstance);
//
// // DependentTaskExecThread taskExecThread = new
...
// new DependentExecute(new ArrayList<>(), DependentRelation.AND,
...
// * notice: should be filled with setDependence() and be passed to
// setupTaskInstance()
// */
...
// */
// private DependentItem getDependentItemFromTaskNode(Long
// processDefinitionCode, long taskCode, String date,
// String cycle) {
// DependentItem dependentItem = new DependentItem();
...
// }
//
// private ProcessInstance getProcessInstanceForFindLastRunningProcess(int
// processInstanceId,
