...
class DynamicLogicTaskTest {
	...
	public void setUp() {
		...
		dynamicLogicTask = new DynamicLogicTask(taskExecutionContext, processInstanceDao, taskInstanceDao,
				subWorkflowService, processService, processDefineMapper, commandMapper);
	}
