...
public class PriorityDelayTaskExecuteRunnableTest {
	...
	public void testCompareTo() {
		...
		PriorityDelayTaskExecuteRunnable p1 = new DefaultTaskExecuteRunnable(workflowInstance, t1, context1,
				taskOperatorManager);
		PriorityDelayTaskExecuteRunnable p2 = new DefaultTaskExecuteRunnable(workflowInstance, t2, context2,
				taskOperatorManager);
