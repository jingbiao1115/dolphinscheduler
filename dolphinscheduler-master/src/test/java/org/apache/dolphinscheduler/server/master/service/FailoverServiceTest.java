...
public class FailoverServiceTest {
	...
	public void before() throws Exception {
		...
		MasterFailoverService masterFailoverService = new MasterFailoverService(registryClient, masterConfig,
				processService, processInstanceExecCacheManager);
		WorkerFailoverService workerFailoverService = new WorkerFailoverService(registryClient, masterConfig,
				processService, workflowExecuteThreadPool, cacheManager, taskInstanceDao);
