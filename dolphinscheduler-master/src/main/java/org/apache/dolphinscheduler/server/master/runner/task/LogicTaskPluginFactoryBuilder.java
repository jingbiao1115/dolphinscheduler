...
public class LogicTaskPluginFactoryBuilder {
	...
	public LogicTaskPluginFactoryBuilder(List<ILogicTaskPluginFactory> logicTaskPluginFactories) {
		logicTaskPluginFactories.forEach(logicTaskPluginFactory -> logicTaskPluginFactoryMap
				.put(logicTaskPluginFactory.getTaskType(), logicTaskPluginFactory));
	}

	public ILogicTaskPluginFactory createILogicTaskPluginFactory(String taskType)
			throws LogicTaskFactoryNotFoundException {
