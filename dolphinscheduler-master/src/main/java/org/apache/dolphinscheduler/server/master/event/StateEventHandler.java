...
public interface StateEventHandler {
	 ...
	 *             this exception means it can be recovered.
	 * @throws StateEventHandleError
	 *             this exception means it cannot be recovered, so the event need to
	 *             drop.
	 * @throws StateEventHandleException
	 *             this means it can be recovered.
	 */
	boolean handleStateEvent(WorkflowExecuteRunnable workflowExecuteRunnable, StateEvent stateEvent)
			throws StateEventHandleException, StateEventHandleError, StateEventHandleFailure;
