...
public class MasterConfig implements Validator {
	...
	/**
	 * The thread number used to prepare processInstance. This number shouldn't
	 * bigger than fetchCommandNum.
	 */
	private int preExecThreads = 10;
	/**
	 * todo: We may need to split the process/task into different thread size. The
	 * thread number used to handle processInstance and task event. Will create two
	 * thread poll to execute {@link WorkflowExecuteRunnable} and
	 * {@link TaskExecuteRunnable}.
	 */
	...
	/**
	 * state wheel check interval, if this value is bigger, may increase the delay
	 * of task/processInstance.
	 */
