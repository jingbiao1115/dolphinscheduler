...
public class HostWeight {
	...
	public HostWeight(HostWorker hostWorker, double cpuUsage, double memoryUsage, double diskUsage,
			double threadPoolUsage, long startTime) {
	...
	private double calculateWeight(double cpuUsage, double memoryUsage, double diskUsage, double threadPoolUsage,
			long startTime) {
