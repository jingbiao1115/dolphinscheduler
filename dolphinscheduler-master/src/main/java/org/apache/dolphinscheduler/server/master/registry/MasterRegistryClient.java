...
/**
 * <p>
 * DolphinScheduler master register client, used to connect to registry and hand
 * the registry events.
 * <p>
 * When the Master node startup, it will register in registry center. And start
 * a {@link MasterHeartBeatTask} to update its metadata in registry.
 */
@Component
@Slf4j
