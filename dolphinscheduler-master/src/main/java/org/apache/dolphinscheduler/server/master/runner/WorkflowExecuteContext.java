...
public class WorkflowExecuteContext implements IWorkflowExecuteContext {
	...
	// todo: we need to add a task instance graph, then move the task instance from
	// WorkflowExecuteRunnable to
	// WorkflowExecuteContext
	@Getter
	private final IWorkflowGraph workflowGraph;

	public WorkflowExecuteContext(ProcessDefinition workflowDefinition, ProcessInstance workflowInstance,
