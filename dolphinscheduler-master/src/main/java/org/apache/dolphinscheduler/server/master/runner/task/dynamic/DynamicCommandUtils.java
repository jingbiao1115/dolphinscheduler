...
public class DynamicCommandUtils {
	...
	static public Command createCommand(ProcessInstance processInstance, Long subProcessDefinitionCode,
			Integer subProcessDefinitionVersion, Map<String, String> parameters) {
