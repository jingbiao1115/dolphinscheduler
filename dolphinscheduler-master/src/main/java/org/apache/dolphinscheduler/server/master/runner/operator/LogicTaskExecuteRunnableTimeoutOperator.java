...
public class LogicTaskExecuteRunnableTimeoutOperator extends BaseTaskExecuteRunnableTimeoutOperator {
	...
	protected void killRemoteTaskInstanceInThreadPool(TaskInstance taskInstance) {
		...
		final ILogicTaskInstanceOperator iLogicTaskInstanceOperator = SingletonJdkDynamicRpcClientProxyFactory
		...
		final LogicTaskKillResponse taskInstanceKillResponse = iLogicTaskInstanceOperator
				.killLogicTask(taskInstanceKillRequest);
