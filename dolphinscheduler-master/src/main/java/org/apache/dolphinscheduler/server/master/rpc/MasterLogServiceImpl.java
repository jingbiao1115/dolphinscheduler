...
public class MasterLogServiceImpl implements ILogService {
	...
	public TaskInstanceLogFileDownloadResponse getTaskInstanceWholeLogFileBytes(
			TaskInstanceLogFileDownloadRequest logicTaskInstanceLogFileDownloadRequest) {
		byte[] bytes = LogUtils
				.getFileContentBytes(logicTaskInstanceLogFileDownloadRequest.getTaskInstanceLogAbsolutePath());
	...
	public TaskInstanceLogPageQueryResponse pageQueryTaskInstanceLog(
		...
		List<String> lines = LogUtils.readPartFileContent(
				...
				taskInstanceLogPageQueryRequest.getSkipLineNum(), taskInstanceLogPageQueryRequest.getLimit());
