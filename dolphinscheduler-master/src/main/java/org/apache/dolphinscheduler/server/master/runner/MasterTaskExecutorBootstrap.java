...
public class MasterTaskExecutorBootstrap implements AutoCloseable {
	...
	public void close() throws Exception {
		...
		try (final GlobalTaskDispatchWaitingQueueLooper globalTaskDispatchWaitingQueueLooper1 = globalTaskDispatchWaitingQueueLooper;
				final AsyncMasterTaskDelayQueueLooper asyncMasterTaskDelayQueueLooper1 = asyncMasterTaskDelayQueueLooper) {
			// closed the resource
		}
