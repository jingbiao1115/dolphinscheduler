...
public class TaskUtils {
	...
	// todo: Add to SPI
	private final Set<String> MASTER_TASK_TYPES = Sets.newHashSet(BlockingLogicTask.TASK_TYPE,
			ConditionLogicTask.TASK_TYPE, DependentLogicTask.TASK_TYPE, SubWorkflowLogicTask.TASK_TYPE,
			SwitchLogicTask.TASK_TYPE, DynamicLogicTask.TASK_TYPE);
