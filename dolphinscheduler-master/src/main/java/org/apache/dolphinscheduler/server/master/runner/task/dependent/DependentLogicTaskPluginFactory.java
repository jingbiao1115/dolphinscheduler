...
public class DependentLogicTaskPluginFactory implements ILogicTaskPluginFactory<DependentLogicTask> {
	...
	@Override
	public DependentLogicTask createLogicTask(TaskExecutionContext taskExecutionContext)
			throws LogicTaskInitializeException {
		return new DependentLogicTask(taskExecutionContext, projectDao, processDefinitionDao, taskDefinitionDao,
				taskInstanceDao, processInstanceDao, processInstanceExecCacheManager);
	}
