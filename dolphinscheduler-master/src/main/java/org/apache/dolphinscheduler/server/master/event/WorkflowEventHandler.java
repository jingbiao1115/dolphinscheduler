...
public interface WorkflowEventHandler {
	 ...
	 *
	 * @throws WorkflowEventHandleError
	 *             if this exception happen, means the event is broken, need to drop
	 *             this event.
	 * @throws WorkflowEventHandleException
	 *             if this exception happen, means we need to retry this event.
	 */
