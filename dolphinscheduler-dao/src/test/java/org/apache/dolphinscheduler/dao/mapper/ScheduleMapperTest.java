...
public class ScheduleMapperTest extends BaseDaoTest {
	...
	public void testQueryByProcessDefineIdPaging() {
		...
		IPage<Schedule> scheduleIPage = scheduleMapper.queryByProcessDefineCodePaging(page, processDefinition.getCode(),
				"");
	...
	public void testSelectAllByProcessDefineArray() {
		...
		List<Schedule> schedules = scheduleMapper
				.selectAllByProcessDefineArray(new long[]{schedule.getProcessDefinitionCode()});
		Assertions.assertNotEquals(0, schedules.size());
	}
