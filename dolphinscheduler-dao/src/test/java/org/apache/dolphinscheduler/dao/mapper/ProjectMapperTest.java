...
public class ProjectMapperTest extends BaseDaoTest {
	...
	public void testQueryProjectListPaging() {
		...
		IPage<Project> projectIPage = projectMapper.queryProjectListPaging(page, null, null);
		IPage<Project> projectIPage1 = projectMapper.queryProjectListPaging(page, null, project.getName());
	...
	public void testQueryProjectExceptUserId() {
		...
		List<Project> projects = projectMapper.queryProjectExceptUserId(100000);
