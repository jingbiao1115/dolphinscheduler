...
public class ErrorCommandMapperTest extends BaseDaoTest {
	...
	public void testQuery() {
		...
		List<CommandCount> commandCounts = errorCommandMapper.countCommandState(null, null, Lists.newArrayList(0L));

		List<CommandCount> commandCounts2 = errorCommandMapper.countCommandState(null, null,
