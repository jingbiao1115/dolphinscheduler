...
public class TaskInstanceMapperTest extends BaseDaoTest {
	...
	public void testFindValidTaskListByProcessId() {
		...
		List<TaskInstance> taskInstances = taskInstanceMapper.findValidTaskListByProcessId(task.getProcessInstanceId(),
		...
		List<TaskInstance> taskInstances1 = taskInstanceMapper.findValidTaskListByProcessId(task.getProcessInstanceId(),
				Flag.NO, processInstance.getTestFlag());
	...
	public void testQueryByInstanceIdAndCode() {
		...
		TaskInstance taskInstance = taskInstanceMapper.queryByInstanceIdAndCode(task.getProcessInstanceId(),
				task.getTaskCode());
		taskInstanceMapper.deleteById(task.getId());
	...
	public void testQueryByProcessInstanceIdsAndTaskCodes() {
		...
		List<TaskInstance> taskInstances = taskInstanceMapper.queryByProcessInstanceIdsAndTaskCodes(
				Collections.singletonList(task.getProcessInstanceId()), Collections.singletonList(task.getTaskCode()));
		taskInstanceMapper.deleteById(task.getId());
	...
	public void testcountTaskInstanceStateByProjectCodes() {
		...
		List<TaskInstanceStatusCountDto> taskInstanceStatusCountDtos = taskInstanceMapper
				.countTaskInstanceStateByProjectCodes(null, null, Lists.newArrayList(task.getProjectCode()));
	...
	public void testQueryTaskInstanceListPaging() {
		...
		IPage<TaskInstance> taskInstanceIPage = taskInstanceMapper.queryTaskInstanceListPaging(page,
				definition.getProjectCode(), task.getProcessInstanceId(), "", "", "", null, "", new int[0], "",
				TaskExecuteType.BATCH, null, null);
