...
public class WorkFlowLineageMapperTest extends BaseDaoTest {
	...
	public void testQueryCodeRelation() {
		...
		List<ProcessLineage> workFlowLineages = workFlowLineageMapper.queryProcessLineageByCode(
				processTaskRelation.getProjectCode(), processTaskRelation.getProcessDefinitionCode());
		Assertions.assertNotEquals(0, workFlowLineages.size());
	}
	...
	public void testQueryWorkFlowLineage() {
		...
		List<ProcessLineage> workFlowLineages = workFlowLineageMapper
				.queryProcessLineage(processDefinition.getProjectCode());
		Assertions.assertNotEquals(0, workFlowLineages.size());
	}
