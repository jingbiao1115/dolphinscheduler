...
public class ProcessDefinitionLogMapperTest extends BaseDaoTest {
	...
	public void testQueryByDefinitionName() {
		...
		List<ProcessDefinitionLog> processDefinitionLogs = processDefinitionLogMapper.queryByDefinitionName(1L,
				"def 1");
	...
	public void testQueryByDefinitionCode() {
		...
		List<ProcessDefinitionLog> processDefinitionLogs = processDefinitionLogMapper.queryByDefinitionCode(1L);
	...
	public void testQueryByDefinitionCodeAndVersion() {
		...
		ProcessDefinitionLog processDefinitionLogs = processDefinitionLogMapper.queryByDefinitionCodeAndVersion(1L, 1);
	...
	public void testQueryProcessDefinitionVersionsPaging() {
		...
		IPage<ProcessDefinitionLog> processDefinitionLogs = processDefinitionLogMapper
				.queryProcessDefinitionVersionsPaging(page, 1L, 1L);
