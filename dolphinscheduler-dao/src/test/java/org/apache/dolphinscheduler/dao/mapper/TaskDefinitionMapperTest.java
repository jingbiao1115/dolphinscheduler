...
public class TaskDefinitionMapperTest extends BaseDaoTest {
	...
	public void testQueryAllDefinitionList() {
		TaskDefinition taskDefinition = insertOne();
		List<TaskDefinition> taskDefinitions = taskDefinitionMapper
				.queryAllDefinitionList(taskDefinition.getProjectCode());
	...
	public void testCountDefinitionGroupByUser() {
		...
		List<WorkflowDefinitionCountDto> users = taskDefinitionMapper
				.countDefinitionGroupByUser(new Long[]{taskDefinition.getProjectCode()});
