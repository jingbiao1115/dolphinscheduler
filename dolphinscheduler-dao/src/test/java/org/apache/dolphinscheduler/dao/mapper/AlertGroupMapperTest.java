...
public class AlertGroupMapperTest extends BaseDaoTest {
	 ...
	 *            alertGroupList
	 */
	private void compareAlertGroups(Map<Integer, AlertGroup> alertGroupMap, List<AlertGroup> alertGroupList) {
	 ...
	 *
	 * @param count
	 *            create AlertGroup count
	 * @param groupName
	 *            groupName
	 * @return AlertGroup map
	 */
	private Map<Integer, AlertGroup> createAlertGroups(Integer count, String groupName) {
