...
public class AlertPluginInstanceMapperTest extends BaseDaoTest {
	...
	/**
	 * Test function queryByInstanceNamePage returning with different search
	 * variables.
	 */
	@Test
	...
	/**
	 * Test function queryAllGlobalAlertPluginInstanceList returning with different
	 * search variables.
	 */
	@Test
	 ...
	 * <p>
	 * Create a new plugin define if not exists, else just return exists plugin
	 * define
	 *
	 * @return PluginDefine
	 */
