...
public interface ProcessDefinitionLogMapper extends BaseMapper<ProcessDefinitionLog> {
	...
	/**
	 * query the certain process definition version info by process definition code
	 * and version number
	 *
	 * @param code
	...
	/**
	 * delete the certain process definition version by process definition id and
	 * version number
	 *
	 * @param code
	 *            process definition code
