...
public class TaskInstanceUtils {
	 ...
	 *
	 * @param source
	 *            Given task instance, copy from.
	 * @param target
	 *            Given task instance, copy to
	...
	public static void copyTaskInstance(TaskInstance source, TaskInstance target) {
		...
		// todo: we need to cpoy the task params and then copy switchDependency, since
		// the setSwitchDependency rely on
