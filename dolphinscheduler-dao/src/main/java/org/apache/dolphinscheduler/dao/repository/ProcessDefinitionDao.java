...
public interface ProcessDefinitionDao extends IDao<ProcessDefinition> {
	 ...
	 * If the searchValue is not null, will used at processDefinitionName or
	 * processDefinitionDescription.
	 */
	// todo: Right now this method will use fuzzy query at searchVal, this will be
	// very slow if there are exist a lot of
	// processDefinition belongs to the target user/project.
	PageListingResult<ProcessDefinition> listingProcessDefinition(int pageNumber, int pageSize,
			@Nullable String searchVal, int userId, long projectCode);
