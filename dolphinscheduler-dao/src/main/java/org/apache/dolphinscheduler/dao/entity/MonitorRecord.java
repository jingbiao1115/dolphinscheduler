...
public class MonitorRecord {
	...
	public String toString() {
		return "MonitorRecord{" + "state=" + state + ", dbType=" + dbType + ", maxConnections=" + maxConnections
				+ ", maxUsedConnections=" + maxUsedConnections + ", threadsConnections=" + threadsConnections
				+ ", threadsRunningConnections=" + threadsRunningConnections + ", date=" + date + '}';
	}
