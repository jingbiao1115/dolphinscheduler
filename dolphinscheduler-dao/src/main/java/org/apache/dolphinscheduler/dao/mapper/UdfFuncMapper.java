...
public interface UdfFuncMapper extends BaseMapper<UdfFunc> {
	 ...
	 */
	List<UdfFunc> queryUdfByIdStr(@Param("ids") Integer[] ids, @Param("funcNames") String funcNames);
	 ...
	 */
	IPage<UdfFunc> queryUdfFuncPaging(IPage<UdfFunc> page, @Param("ids") List<Integer> ids,
	 ...
	 * @return udf function list
	 */
	List<UdfFunc> getUdfFuncByType(@Param("ids") List<Integer> ids, @Param("type") Integer type);
	 ...
	 * 
	 * @param resourceFullNames
	 *            resource fullName array
	 * @return UDF function list
	 */
