...
public interface ScheduleMapper extends BaseMapper<Schedule> {
	 ...
	 */
	List<Schedule> queryReleaseSchedulerListByProcessDefinitionCode(
	...
	IPage<Schedule> queryByProcessDefineCodePaging(IPage<Schedule> page,
			@Param("processDefinitionCode") long processDefinitionCode, @Param("searchVal") String searchVal);
	 ...
	 */
	IPage<Schedule> filterSchedules(IPage<Schedule> page, @Param("schedule") Schedule schedule);
	 ...
	 * @return schedule
	 */
	List<Schedule> querySchedulesByProcessDefinitionCodes(
			@Param("processDefinitionCodeList") List<Long> processDefinitionCodeList);
