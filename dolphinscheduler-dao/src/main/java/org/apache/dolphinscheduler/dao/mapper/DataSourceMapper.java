...
public interface DataSourceMapper extends BaseMapper<DataSource> {
	 ...
	 */
	IPage<DataSource> selectPaging(IPage<DataSource> page, @Param("userId") int userId, @Param("name") String name);
	 ...
	 * @param name
	 *            datasource name
	 * @return If the name does not exist or the user does not have permission, it
	 *         will return null
	 */
	...
	IPage<DataSource> selectPagingByIds(Page<DataSource> dataSourcePage,
			@Param("dataSourceIds") List<Integer> dataSourceIds, @Param("name") String name);
}
