...
public class TaskInstance implements Serializable {
	...
	public boolean isTaskComplete() {
		...
		return this.getState().isSuccess() || this.getState().isKill()
				|| (this.getState().isFailure() && !taskCanRetry()) || this.getState().isForceSuccess();
	}
	...
	/**
	 * determine if a task instance can retry if subProcess,
	 *
