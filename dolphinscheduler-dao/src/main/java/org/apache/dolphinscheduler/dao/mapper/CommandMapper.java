...
public interface CommandMapper extends BaseMapper<Command> {
	 ...
	 */
	List<CommandCount> countCommandState(@Param("startTime") Date startTime, @Param("endTime") Date endTime,
	 ...
	 * @return command list
	 */
	List<Command> queryCommandPageBySlot(@Param("limit") int limit, @Param("masterCount") int masterCount,
