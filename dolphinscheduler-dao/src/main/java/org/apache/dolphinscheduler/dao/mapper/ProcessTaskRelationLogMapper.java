...
public interface ProcessTaskRelationLogMapper extends BaseMapper<ProcessTaskRelationLog> {
	 ...
	 * @return int
	 */
	int deleteByCode(@Param("processCode") long processCode, @Param("processVersion") int processVersion);
	 ...
	 * @return process task relation log
	 */
	ProcessTaskRelationLog queryRelationLogByRelation(
			@Param("processTaskRelation") ProcessTaskRelation processTaskRelation);
