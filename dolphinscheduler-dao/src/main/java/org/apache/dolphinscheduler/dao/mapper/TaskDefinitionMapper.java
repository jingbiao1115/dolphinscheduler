...
public interface TaskDefinitionMapper extends BaseMapper<TaskDefinition> {
	 ...
	 */
	TaskDefinition queryByName(@Param("projectCode") long projectCode, @Param("processCode") long processCode,
	 ...
	 */
	IPage<TaskMainInfo> queryDefineListPaging(IPage<TaskMainInfo> page, @Param("projectCode") long projectCode,
			@Param("searchTaskName") String searchTaskName, @Param("taskType") String taskType,
