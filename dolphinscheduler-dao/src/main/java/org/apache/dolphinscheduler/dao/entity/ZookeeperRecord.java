...
public class ZookeeperRecord {
	...
	public String toString() {
		return "ZookeeperRecord{" + "hostname='" + hostname + '\'' + ", connections=" + connections + ", watches="
				+ watches + ", sent=" + sent + ", received=" + received + ", mode='" + mode + '\'' + ", minLatency="
				+ minLatency + ", avgLatency=" + avgLatency + ", maxLatency=" + maxLatency + ", nodeCount=" + nodeCount
