...
public interface TaskGroupQueueDao extends IDao<TaskGroupQueue> {
	...
	/**
	 * Query all {@link TaskGroupQueue} which in_queue is
	 * {@link org.apache.dolphinscheduler.common.enums.Flag#YES}
	 *
	...
	/**
	 * Query all {@link TaskGroupQueue} which in_queue is
	 * {@link org.apache.dolphinscheduler.common.enums.Flag#YES} and taskGroupId is
	 * taskGroupId
	 *
	 * @param taskGroupId
	 *            taskGroupId
	 ...
	 * TaskGroupQueueStatus.ACQUIRE_SUCCESS and forceStart is
