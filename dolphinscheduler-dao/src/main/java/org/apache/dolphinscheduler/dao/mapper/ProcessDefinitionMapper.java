...
public interface ProcessDefinitionMapper extends BaseMapper<ProcessDefinition> {
	 ...
	 */
	IPage<ProcessDefinition> queryDefineListPaging(IPage<ProcessDefinition> page, @Param("searchVal") String searchVal,
			@Param("userId") int userId, @Param("projectCode") long projectCode);
	 ...
	 * @return process definition list
	 */
	List<DependentSimplifyDefinition> queryDefinitionListByProjectCodeAndProcessDefinitionCodes(
			@Param("projectCode") long projectCode, @Param("codes") Collection<Long> codes);
	 ...
	 * <p>
	 * We only need project codes to determine whether the definition belongs to the
	 * user or not.
	 *
	 * @param projectCodes
	 *            projectCodes
	 ...
	 */
	List<WorkflowDefinitionCountDto> countDefinitionByProjectCodes(
	...
	List<WorkflowDefinitionCountDto> countDefinitionByProjectCodesV2(@Param("projectCodes") List<Long> projectCodes,
			@Param("userId") Integer userId, @Param("releaseState") Integer releaseState);
