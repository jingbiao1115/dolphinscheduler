...
public class ProcessInstance {
	...
	public ProcessInstance(ProcessDefinition processDefinition) {
		...
		this.name = String.join("-", processDefinition.getName(), String.valueOf(processDefinition.getVersion()),
	...
	/**
	 * get current command type, if start with complement data,return complement
	 *
	 * @return CommandType
	 */
