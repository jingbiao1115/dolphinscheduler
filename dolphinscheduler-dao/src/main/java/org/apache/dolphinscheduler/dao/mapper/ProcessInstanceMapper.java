...
public interface ProcessInstanceMapper extends BaseMapper<ProcessInstance> {
	...
	IPage<ProcessInstance> queryProcessInstanceListPaging(Page<ProcessInstance> page,
			@Param("projectCode") Long projectCode, @Param("processDefinitionCode") Long processDefinitionCode,
			@Param("searchVal") String searchVal, @Param("executorName") String executorName,
			@Param("states") int[] statusArray, @Param("host") String host, @Param("startTime") Date startTime,
	 ...
	 *
	 * @param originWorkerGroupName
	 *            originWorkerGroupName
	 * @param destWorkerGroupName
	 *            destWorkerGroupName
	 * @return update result
	 */
	 ...
	 * <p>
	 * We only need project codes to determine whether the process instance belongs
	 * to the user or not.
	 *
	 * @param startTime
	 *            startTime
	 ...
	 */
	List<WorkflowInstanceStatusCountDto> countWorkflowInstanceStateByProjectCodes(@Param("startTime") Date startTime,
	...
	List<ProcessInstance> queryTopNProcessInstance(@Param("size") int size, @Param("startTime") Date startTime,
			@Param("endTime") Date endTime, @Param("status") WorkflowExecutionStatus status,
	...
	List<ProcessInstance> queryByProcessDefineCodeAndProcessDefinitionVersionAndStatusAndNextId(
			@Param("processDefinitionCode") Long processDefinitionCode,
			@Param("processDefinitionVersion") int processDefinitionVersion, @Param("states") int[] states,
			@Param("id") Integer id);

	int updateGlobalParamsById(@Param("globalParams") String globalParams, @Param("id") int id);
	...
	IPage<ProcessInstance> queryProcessInstanceListV2Paging(Page<ProcessInstance> page,
			...
			@Param("state") Integer state, @Param("host") String host);
	 ...
	 * @return ExecuteStatusCount list
	 */
	List<ExecuteStatusCount> countInstanceStateV2(@Param("startTime") Date startTime, @Param("endTime") Date endTime,
			@Param("projectCode") Long projectCode, @Param("workflowCode") Long workflowCode,
			@Param("model") Integer model, @Param("projectIds") Set<Integer> projectIds);
