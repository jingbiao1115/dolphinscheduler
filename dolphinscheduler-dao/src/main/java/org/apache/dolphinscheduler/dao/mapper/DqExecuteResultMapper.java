...
public interface DqExecuteResultMapper extends BaseMapper<DqExecuteResult> {
	 ...
	 */
	IPage<DqExecuteResult> queryResultListPaging(IPage<DqExecuteResult> page, @Param("searchVal") String searchVal,
			@Param("user") User user, @Param("states") int[] statusArray, @Param("ruleType") int ruleType,
