...
public class CuringParamsServiceTest {
	...
	public void testCuringGlobalParams() {
		...
		Property testStartParam2Property = new Property("testStartParam2", Direct.IN, DataType.VARCHAR,
				"$[yyyy-MM-dd+1]");
	...
	public void testParamParsingPreparation() {
		...
		Map<String, Property> propertyMap = dolphinSchedulerCuringGlobalParams.paramParsingPreparation(taskInstance,
