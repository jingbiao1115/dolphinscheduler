...
public class TaskPriorityQueueImplTest {
	...
	public void testSort() {
		...
		Assertions.assertEquals(Arrays.asList(priorityOne, priorityTwo, priorityThree), taskPriorities);
		...
		Collections.sort(taskPriorities);
		Assertions.assertEquals(Arrays.asList(priorityThree, priorityTwo, priorityOne), taskPriorities);
	}
