...
public class TaskPriorityQueueImpl implements TaskPriorityQueue<TaskPriority> {
	...
	/**
	 * Task queue, this queue is unbounded, this means it will cause
	 * OutOfMemoryError. The master will stop to generate the task if memory is too
	 * high.
	 */
