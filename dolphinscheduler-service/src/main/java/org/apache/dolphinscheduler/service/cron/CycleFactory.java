...
public class CycleFactory {
	...
	public static class DayCycle extends AbstractCycle {
		...
		protected CycleEnum getCycle() {
			...
			if (minFiledIsSetAll() && hourFiledIsSetAll() && dayOfMonthFieldIsEvery()
	...
	public static class HourCycle extends AbstractCycle {
		...
		@Override
		protected CycleEnum getCycle() {
			if (minFiledIsSetAll() && hourFiledIsEvery() && dayOfMonthField.getExpression() instanceof Always
					&& dayOfWeekField.getExpression() instanceof QuestionMark
					&& monthField.getExpression() instanceof Always) {
	...
	public static class MinCycle extends AbstractCycle {
		...
		@Override
		protected CycleEnum getCycle() {
			if (minFiledIsEvery() && hourField.getExpression() instanceof Always
	...
	public static class MonthCycle extends AbstractCycle {
		...
		@Override
		protected CycleEnum getCycle() {
			boolean flag = (minFiledIsSetAll() && hourFiledIsSetAll() && dayOfMonthFieldIsSetAll()
					&& dayOfWeekField.getExpression() instanceof QuestionMark && monthFieldIsEvery())
					|| (minFiledIsSetAll() && hourFiledIsSetAll()
							&& dayOfMonthField.getExpression() instanceof QuestionMark && dayofWeekFieldIsSetAll()
							&& monthFieldIsEvery());
			if (flag) {
	...
	public static class WeekCycle extends AbstractCycle {
		...
		@Override
		protected CycleEnum getCycle() {
			if (minFiledIsSetAll() && hourFiledIsSetAll() && dayOfMonthField.getExpression() instanceof QuestionMark
					&& dayofWeekFieldIsEvery() && monthField.getExpression() instanceof Always) {
	...
	public static class YearCycle extends AbstractCycle {
		...
		protected CycleEnum getCycle() {
			boolean flag = (minFiledIsSetAll() && hourFiledIsSetAll() && dayOfMonthFieldIsSetAll()
					&& dayOfWeekField.getExpression() instanceof QuestionMark && monthFieldIsSetAll())
					&& yearFieldIsEvery()
					|| (minFiledIsSetAll() && hourFiledIsSetAll()
							&& dayOfMonthField.getExpression() instanceof QuestionMark && dayofWeekFieldIsSetAll()
							&& monthFieldIsSetAll() && yearFieldIsEvery());
