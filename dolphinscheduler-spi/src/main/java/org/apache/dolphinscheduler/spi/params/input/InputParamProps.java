...
public class InputParamProps extends ParamsProps {
	...
	/**
	 * adaptive content height, only valid for type="textarea", objects can be
	 * passed in, such as {minRows: 2, maxRows: 6}
	 */
	...
	/**
	 * control whether it can be zoomed by the user, the value is none, both,
	 * horizontal, vertical
	 */
	...
	/**
	 * whether to trigger the verification of the form during input, the default
	 * value is true
	 */
