...
public class SwitchParamProps extends ParamsProps {
	...
	/**
	 * the class name of the icon displayed when the switch is turned on, setting
	 * this option will ignore active-text
	 */
	private String activeIconClass;

	/**
	 * the class name of the icon displayed when the switch is closed, setting this
	 * option will ignore inactive-text
	 */
