...
/**
 * DataQualityApplication is spark application. It mainly includes three
 * components: reader, transformer and writer. These three components realize
 * the functions of connecting data, executing intermediate SQL and writing
 * execution results and error data to the specified storage engine
 */
@Slf4j
public class DataQualityApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		DataQualityConfiguration dataQualityConfiguration = JsonUtils.fromJson(dataQualityParameter,
		...
		boolean hiveClientSupport = dataQualityConfiguration.getReaderConfigs().stream()
		...
		DataQualityContext dataQualityContext = new DataQualityContext(sparkRuntimeEnvironment,
